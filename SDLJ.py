...
for i in range(num):
    vx = int(nelec[i])
    if nelec[i] == 1:
        print "Atom No "+str(i), "Beta =", paramsn[i*4 + 1]/0.529177, "Ionization Energy =", (((paramsn[i*4 + 1])**2)/8)*630 , "N =", paramsn[i*4 + 0], "Partial Charge =", nelec[i]-paramsn[i*4 + 0], "Sigma H_NonPol =", (paramsn[i*4 + 1]/0.529177)/12.33, "Epsilon H_NonPol =", (191.68*(paramsn[i*4 + 1]/0.529177)**2)/(32*(12.33**6)), "Sigma H_Pol =", (paramsn[i*4 + 1]/0.529177)/7.45, "Epsilon H_NonPol =", (8.32*(paramsn[i*4 + 1]/0.529177)**2)/(32*(7.45**6))         
    if nelec[i] == 6:
        print "Atom No "+str(i), "Beta =",  paramsn[i*4 + 3]/0.529177, "Ionization Energy =", (((paramsn[i*4 + 3])**2)/8)*630 , "N =", paramsn[i*4 + 2], "Partial Charge =", nelec[i]-(paramsn[i*4 + 0]+paramsn[i*4 + 2]), "Sigma C =", (paramsn[i*4 + 1]/0.529177)/12.99, "Epsilon C =", (1355.84*(paramsn[i*4 + 1]/0.529177)**2)/(32*(12.99**6))
    if nelec[i] == 7:
        print "Atom No "+str(i), "Beta =",  paramsn[i*4 + 3]/0.529177, "Ionization Energy =", (((paramsn[i*4 + 3])**2)/8)*630 , "N =", paramsn[i*4 + 2], "Partial Charge =", nelec[i]-(paramsn[i*4 + 0]+paramsn[i*4 + 2]), "Sigma N =", (paramsn[i*4 + 1]/0.529177)/14.08, "Epsilon N =", (7360.32*(paramsn[i*4 + 1]/0.529177)**2)/(32*(14.08**6))
    if nelec[i] == 8:
        print "Atom No "+str(i), "Beta =",  paramsn[i*4 + 3]/0.529177, "Ionization Energy =", (((paramsn[i*4 + 3])**2)/8)*630 , "N =", paramsn[i*4 + 2], "Partial Charge =", nelec[i]-(paramsn[i*4 + 0]+paramsn[i*4 + 2]), "Sigma O =", (paramsn[i*4 + 1]/0.529177)/12.63, "Epsilon O =", (1345.60*(paramsn[i*4 + 1]/0.529177)**2)/(32*(12.63**6))
